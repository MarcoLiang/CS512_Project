...
class MetaPathGenerator:
    def __init__(self, max_path_length, type_num=3, label_by = 'focus', train_ratio=0.7, random_prob=[1/3, 1/3, 1/3]):
...
def main():
    ...
    meta = MetaPathGenerator(5, 3, "focus", train_ratio=r, random_prob=random_prob)
